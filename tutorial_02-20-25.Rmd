...
We downloaded the CalEnviroScreen data from their website and uploaded it to the Schell Lab Drive. This is in .gdb format, but works similarly to shapefiles. 
...
That's it for part 1 -- next time we'll work on rasterizing shapefiles to extract buffer from them in the same way as we did for the rasters, as well as making pretty maps in ggplot! 